...
class AddCourse :
    def __init__(self,db):
        ...
        self.hours_entry_label = Label(self.console, text="Hours Required :")
        self.hours_entry_label.grid(row=1, column=0, padx=5, pady=5)

        self.hours_entry = Entry(self.console, width=20)
        self.hours_entry.grid(row=1, column=3, padx=5, pady=5)

        self.add_course_b = Button(self.console, text="Add Course", command=self.on_add_course)
        self.add_course_b.grid(row=2, column=2, padx=10, pady=10, ipadx=10, ipady=5)

        self.del_course_b = Button(self.console, text="Delete Course", command=self.on_del_course)
        self.del_course_b.grid(row=2, column=5, padx=10, pady=10, ipadx=10, ipady=5)
        ...
        self.tr_vw.heading(2, text="Hours")
    ...
    def on_del_course(self):
        ...
        self.db.delete_course(code=self.info[0], hours=self.info[1])
        self.update_tree()
...
if __name__ == '__main__':
    AddCourse(backend.DataBase(0,0))