...
class App(tk.Tk):
    def __init__(self):
        ...
        self.iconphoto(False, tk.PhotoImage(file="C:\\Users\\oknor\\Documents\\Programming\\Time-Table-Generator\\sample-tkinter-application-structure-main\\assets\\title_icon.png"))
